var WikiquoteApi = (function() {
  ...
  var API_URL = "https://pl.wikiquote.org/w/api.php";
...
function newRandomQuote() {
  ...
  authorTag.fadeOut("slow", function(){
    $(this).html("<p>" + currentQuote[1] + "</p>").fadeIn("slow");
  });
...
function parseQuotes(short) {
  if (html !== "" || html !== null || html !== undefined) {
    ...
    $.each(liList, function(key, element){
      ...
      if (short !== true || qString[0].split("").length <= 140)
...
$(document).ready(function(){
  ...
  fetchQuotes();
  setInterval(fetchQuotes,900000);  
